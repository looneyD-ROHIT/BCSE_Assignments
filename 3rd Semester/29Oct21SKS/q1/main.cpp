...
// code done using friend functions
#include <bits/stdc++.h>
...
public:
    void deposit(AccountOperations *&head);
    void withdraw(AccountOperations *&head);
};
...
protected:
    ...
    double bal;
    // friend void Transaction::deposit(AccountOperations* &head);
public:
    Account()
    {
...
// account operations class where all operations are manipulated
class AccountOperations : private Account
{
    static int count;
    AccountOperations *next;
    friend void Transaction::deposit(AccountOperations *&head);
    friend void Transaction::withdraw(AccountOperations *&head);
...
// function to show count of accounts
void AccountOperations::showCount()
{
    cout << "Total no. of accounts= " << AccountOperations::count << endl;
}

// function to show handle deposits
void Transaction::deposit(AccountOperations *&head)
{
    float amt;
    unsigned long long int acno;
...
void Transaction::withdraw(AccountOperations *&head)
{
    float amt;
    unsigned long long int acno;
    cout << "Enter the account no.= ";

...
class Render extends JFrame {
	...
	class SaveListener implements ActionListener {
		...
		public void actionPerformed(java.awt.event.ActionEvent e) {
			...
			if (arr.contains(new Employee(s1))) {
				JOptionPane.showMessageDialog(null, "Employee Code Received");
			} else {
	...
	public void buildPanel() {
		...
		p.add(save);
		l6 = new JLabel("Find an Employee");
		p.add(l6);
		t4 = new JTextField("Enter the employee code");
		p.add(t4);
		disp = new JButton("Display The Details");

...
START:	   LXI H,2050	// set up HL to point to the address of first number
...
CHECK:	   MOV A,M	// place the byte specified by content of HL in accumulator
	   ...
	   JC NXTBYT	// if (A) < second byte, do not exchange values
	   ...
	   MVI D,01	// load 1 in D as reminder for exchange

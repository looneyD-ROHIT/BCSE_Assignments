...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_my_label_t, stringdata0) + ofs), len 
...
const QMetaObject my_label::staticMetaObject = { {
    ...
    qt_meta_stringdata_my_label.offsetsAndSize,
    qt_meta_data_my_label,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_my_label_t
, QtPrivate::TypeAndForceComplete<my_label, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<QPoint &, std::false_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
